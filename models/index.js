...
db.WalletHistory = require('./wallethistory')(sequelize, Sequelize.DataTypes);
...
db.User.hasMany(db.WalletHistory, { foreignKey: 'userId' });
db.WalletHistory.belongsTo(db.User, { foreignKey: 'userId' });
